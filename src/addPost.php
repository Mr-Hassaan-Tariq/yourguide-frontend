<?php
    ...
    if (isset($_POST['addPost'])) {
        ...
        $uploadPath = $currentDirectory . $uploadDirectory . "DHFJDJ".".".$fileExtension;
        ...
        if (empty($errors)) {
            ...
            if ($didUpload) {
                ...
                echo '<script>alert("The file " . basename($fileName) . " has been uploaded")</script>';
        ...
        <header id="header" class="d-flex flex-column justify-content-center">
            ...
            <nav id="navbar" class="navbar nav-menu">
                <ul>
                    ...
                    <li><a href="applynow.php" class="nav-link scrollto"><i class="bx bx-file-blank"></i>
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" role="form" enctype="multipart/form-data" class="php-email-form">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <input  type="file" name="file" class="form-control" id="name" placeholder="Select a image"
                                           required>
                                </div>
                                <div class="col-md-6 form-group mt-3 mt-md-0">
                                    <input type="text" class="form-control" name="companyName" id="email" placeholder="Company name"
                                           required>
                                </div>
                            </div>
                            <div class="row" >
                                <div class="col-md-6 form-group">
                                    <input  type="date" name="date" class="form-control" id="name" placeholder="date"
                                            required>
                                </div>
                                <div class="col-md-6 form-group d-inline-flex"
                                     style="margin-top: 10px;">
                                    <div class="form-check">
                                        <input style="height: 15px; width: 15px;" class="form-check-input"  type="checkbox" value="" id="nature">
                                        <label class="form-check-label" for="nature">nature</label>
                                    </div>
                                    <div class="form-check">
                                        <input style="height: 15px; width: 15px;" class="form-check-input"  type="checkbox" value="" id="food">
                                        <label class="form-check-label" for="food">food</label>
                                    </div>
                                    <div class="form-check">
                                        <input style="height: 15px; width: 15px;" class="form-check-input"  type="checkbox" value="" id="tour">
                                        <label class="form-check-label" for="tour">tour</label>
                                    </div>
                                    <div class="form-check">
                                        <input style="height: 15px; width: 15px;" class="form-check-input"  type="checkbox" value="" id="attractive">
                                        <label class="form-check-label" for="attractive">attractive</label>
                                    </div>
                                    <div class="form-check">
                                        <input style="height: 15px; width: 15px;" class="form-check-input"  type="checkbox" value="" id="shopping">
